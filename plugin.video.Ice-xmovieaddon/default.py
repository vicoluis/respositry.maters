...
Base = 'http://icexmatt.blogspot.mx/p/icexmovie.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.Ice-xMovieAddon') #    modificar("el nombre de tu addons")
